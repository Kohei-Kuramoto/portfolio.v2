      ...
      <section id="contact" className="py-28" style={{ background: "#0D1524" }}>
        <div className="max-w-5xl mx-auto px-8">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <a
              href="mailto:kohey0428@gmail.com"
              className="inline-flex items-center gap-3 px-9 py-4 rounded-xl text-white font-medium transition-all duration-200 hover:-translate-y-1"
              style={{
                background: "#4F8EF7",
                textDecoration: "none",
                fontSize: "17px",
            ...
            >
              ...
              {lang === "en" ? "Send me an Email" : "メールを送る"}
            </a>

            <div className="flex gap-4 justify-center mt-6 flex-wrap">
              <a
                href="https://github.com/Kohei-Kuramoto"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/kohei-kuramoto"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-200 hover:-translate-y-0.5"
                style={{
